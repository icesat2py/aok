...
def basic_request():
    ...
    srextent = [
        {
            "lon": spatial_extent[1],
            "lat": spatial_extent[0]
        },
        {
            "lon": spatial_extent[3],
            "lat": spatial_extent[0]
        },
        {
            "lon": spatial_extent[3],
            "lat": spatial_extent[2]
        },
        {
            "lon": spatial_extent[1],
            "lat": spatial_extent[2]
...
def test_sliderule_output_params_warns_of_no_output_format(basic_request):
    ...
    with pytest.warns(UserWarning, match="output format was not provided. SlideRule parameters will be built without output."):
