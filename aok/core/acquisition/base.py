...
class DataRequest:
    ...
    """
        ...
        if self.output in {"dataframe", "geodataframe"}:
            if self.download_dir is None:
                raise ValueError("download_dir is required when output format is specified.")
    ...
    def _cut_spatial_extent(self) -> None:
        ...
        """
        raise NotImplementedError("_cut_spatial_extent exists but is not implemented yet.")
        '''
