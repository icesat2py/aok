...
def create_diagnostic_plot(
    ...
    plt.scatter(
        nighttime_df[nighttime_df["surface_type"] == "Land"]["solar_elevation"],
        nighttime_df[nighttime_df["surface_type"] == "Land"]["total_background_rate"],
        c="purple",
        alpha=0.5,
        label="Nighttime Land",
    )
    plt.scatter(
        nighttime_df[nighttime_df["surface_type"] == "Ocean"]["solar_elevation"],
        nighttime_df[nighttime_df["surface_type"] == "Ocean"]["total_background_rate"],
        c="lightgreen",
        alpha=0.5,
        label="Nighttime Ocean",
    )
    ...
    plt.legend()
    plt.title(
        "Background Rate vs. Solar Elevation (Land vs. Ocean) with Nighttime Comparison"
    )

    # Save the plot
    plt.savefig(
        os.path.join(output_dir, "background_vs_elevation_with_nighttime_2021.png")
    )
    plt.close()
...
if __name__ == "__main__":
    ...
    df, models = analyze_icesat2_data(
        atl03_directory,
        args.beam,
