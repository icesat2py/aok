...
def get_args():
    ...
    parser.add_argument("--target_beams", type=str, default='',
                        help="Comma-separated beam IDs to process. Empty means auto-select strong beams.")

    parser.add_argument("--enable_solar_background_filter", action="store_true",
                        help="Optional: apply solar background filtering before binning.")
    ...
    parser.add_argument("--solar_background_quantile", type=float, default=0.8,
                        help="Quantile threshold of daytime background rate considered high background.")
    ...
    parser.add_argument("--sea_surface_flattening_window_m", type=int, default=500,
