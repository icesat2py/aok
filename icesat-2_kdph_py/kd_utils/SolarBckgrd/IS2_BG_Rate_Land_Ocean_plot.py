...
def calculate_background_averages(daytime_df, nighttime_df):
    ...
    logger.info(f"Average Nighttime Land Background Rate: {nighttime_land_avg:.2e} ph/s")
    logger.info(f"Average Nighttime Ocean Background Rate: {nighttime_ocean_avg:.2e} ph/s")
...
def plot_background_averages(averages, output_dir):
    ...
    plt.title('Average Background Rate Comparison\n(Daytime vs. Nighttime, Land vs. Ocean)')
    plt.yscale('log')
    plt.ylim(1e3, 1e8)
...
if __name__ == "__main__":
    ...
    analyze_icesat2_data(atl03_directory, args.beam, output_dir=output_dir, shoreline_data_path=shoreline_data_path)
